...
def predict_note_authentication(id, loan_amnt, funded_amnt, term, int_rate, installment, emp_title, emp_length, home_ownership, annual_inc, verification_status):
    ...
    prediction = saved_model.predict([[id, loan_amnt, funded_amnt, term, int_rate, installment, emp_title, emp_length, home_ownership, annual_inc, verification_status]])
    print(prediction)
    return prediction
...
def main():
    ...
    <h2 style="color:white;text-align:center;">Loan Acceptance Neural App </h2>
    </div>
    """
